      ...
      <div
        ...
        <div
          className={cn(
            ...
            {
              'order-2 bg-violet-600 rounded-sm mb-6': message.isUserMessage, // User's avatar styling
              'order-1 bg-zinc-800 rounded-sm mb-6': !message.isUserMessage, // Other person's avatar styling
        ...
        <div
          className={cn(
            'flex flex-col space-y-2 text-base max-w-md mx-2 mb-6', // Styling for the message content container
            {
